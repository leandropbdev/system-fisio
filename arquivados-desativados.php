...
<head>
	<meta charset="utf-8">
	<title>System Fisio - Pacientes arquivados</title>
				...
				<div class="row">
					...
					<div class="col-sm-8 col-12 text-right add-btn-col">
						...
						<div class="view-icons">
							<!-- <a href="all-pacientes.php" class="grid-view btn btn-link"> <i class="fas fa-box"></i> Arquivados/Desativados</a> -->
							<!-- <a href="all-pacientes.php" class="grid-view btn btn-link"><i class="fas fa-th"></i></a>
							<a href="all-pacientes-list.php" class="list-view btn btn-link active"><i class="fas fa-bars"></i></a> -->
						</div>
					</div>
				</div>
							...
							<div class="table-responsive">
								<table class="table custom-table datatable">
									...
									<tbody>
										...
										$querySelectPaciente = "SELECT p.cod_paciente, p.nome_paciente, a.cod_avaliacao, p.data_nasc_paciente, p.sexo_paciente, status FROM
										 pacientes p join avaliacao_paciente a on a.ordem_paciente = p.cod_paciente 
										 join agendamento_paciente ap on ap.ordem_paciente = p.cod_paciente where ap.status = '2' or ap.status = '3'
										...
										?>
												...
												<tr>
													...
													$query_paciente_age = "SELECT ordem_paciente from agendamento_paciente where ordem_paciente = '$codPaciente' ";
