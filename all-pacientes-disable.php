				...
				<div class="page-header">
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-6 col-12">
							<h5 class="text-uppercase mb-0 mt-0 page-title">Todos os pacientes </h5>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-6 col-12">
												...
												<div class="profile-widget">
													...
													<div class="dropdown profile-action">
														...
														<div class="dropdown-menu dropdown-menu-right">
															...
															<a class="dropdown-item btn_delete" href="#" data-toggle="modal" codPaciente="<?php echo $codPaciente; ?>" nomePaciente="<?php echo $nomePaciente; ?>" data-target="#delete_employee"><i class="fas fa-trash-alt m-r-5"></i> Delete</a>
														</div>
													</div>
													<form action="about-paciente.php" method="post">
